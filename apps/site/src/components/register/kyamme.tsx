...
<button
    ...
    className={`flex gap-2 justify-center items-center !py-2 px-4 mb-4 w-full duration-300 ease-in-out text-xs text-white font-normal text-center leading-5 ${
        isSubmitting ? 'bg-themeDarkerAlt' : 'bg-themePrimary'
    }`}
    disabled={isSubmitting}  {/* Move the disabled attribute here */}
>
    {CurrentPage === 6 ? 'Sign Up' : 'Next Step'}
