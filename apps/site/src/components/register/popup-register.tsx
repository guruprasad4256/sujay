...
const PopupRegister = () => {
    ...
    const registrationSteps = ['Role Selection', 'Candidate Info', 'Employer Info', 'Password'];

     // Step indicator component
    const stepIndicator = (
        <div className="flex flex-col items-center justify-between w-20 mr-6">
            ...
            <div className="flex flex-col space-y-2">
                {registrationSteps.map((step, index) => (
                    <div
                        key={index}
                        className={`flex items-center justify-center h-8 w-8 mx-2 rounded-full transition-all duration-300 ${
                            index + 1 === CurrentPage
                                ? 'bg-themePrimary text-white transform scale-110'
    ...
    return (
        ...
        <section
        className={`flex fixed w-full h-full top-0 left-0 bg-[rgba(0,_0,_0,_0.7)] z-[9999] text-white transition-all duration-300 ease-in-out  ${
                    ...
                    <form onSubmit={handleSubmit(onSubmitHandler)}>
                        {CurrentPage === 1 && (
                            <>
                                ...
                                {watch('freelancer_role') === 'candidate' && (
                                    <>  <div className="mb-3">
                                    <label
                                        className="block mb-2 text-themeDarker"
                                        htmlFor=""
                                ...
                                {errors?.phoneNumber && (
                                    <span className="text-red-600 text-xss italic">
                                        ...
                                        {/* ... (other candidate-specific fields) ... */}
                                    </>
                                )}

                                {/* Employer-specific fields */}
                                {watch('freelancer_role') === 'employer' && (
                                    <>  <div className="mb-3">
                                    <label
                                        className="block mb-2 text-themeDarker"
                                        htmlFor=""
                                ...
                                {/* ... (similarly for other common fields) ... */}
                            </>
                        )}
